...
--Valida un String
valTerm :: String -> Bool
valTerm s = numV (elimSub (show (strToEx s)) (delete '(' (delete ')' (delete 'i' (delete '+' (delete '-' (delete '-' (delete '^' (delete 'x' s))))))))) 
...
--Elimina Subcadena
elimSub :: String -> String -> String
elimSub [] s = s
elimSub (x:xs) s = elimSub xs (delete x s)
